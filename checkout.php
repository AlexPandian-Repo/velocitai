			...
			if ($count == 1) {
				...
				if ($ures) {
					...
					foreach ($cart as $key => $value) {
						...
						$total = $total + ($ordr['priceid'] * $value['quantity']);
					}
	...
	<div class="content-blog">
		<form method="post">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<div class="billing-details">
							<h3 class="uppercase" style="color: #FFF;">Billing Details</h3>
							<div class="space30"></div>
							<label class="" style="color: #FFF;">Country </label>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<input name="fname" class="form-control" placeholder="" value="
									<?php
								...
								<div class="col-md-6">
									...
									<input name="lname" class="form-control" placeholder="" value="
									<?php
									if (!empty($r['lastname'])) {
										echo $r['lastname'];
									} elseif (isset($lname)) {
							...
							<?php if (!empty($r['address1'])) {
								echo $r['address1'];
							} elseif (isset($address1)) {
								echo $address1;
							} ?>" type="text">
							<div class="clearfix space20"></div>
							<input name="address2" class="form-control" placeholder="Apartment, suite, unit etc. (optional)" value="
							...
							<div class="row">
								...
								<div class="col-md-4">
									<label style="color: #FFF;">Postcode </label>
							...
							<input name="phone" class="form-control" id="billing_phone" placeholder="" value="
				...
				<h4 class="heading" style="color: #FFF;">Payment Method</h4>
				<div class="clearfix space20"></div>
				<div class="payment-method" style="background-color: #FFF; padding:3rem;">
					<div class="row">
						<div class="col-md-4">
						...
						<div class="col-md-4">
							<input name="payment" value="cheque" id="radio2" class="css-checkbox" type="radio"><span value="cheque">Cheque Payment</span>
							<div class="space20"></div>
							<p>Please send your cheque to BLVCK Fashion House, Oatland Rood, UK, LS71JR</p>
						</div>
						<div class="col-md-4">
							<input name="payment" value="paypal" id="radio3" class="css-checkbox" type="radio"><span value="paypal">Paypal</span>
							<div class="space20"></div>
					...
					<div class="space30"></div>
					<input type="submit" class="button btn-lg" value="Pay Now" style="background-color: #6441A5; border:none;">
				</div>
			</div>
		</form>
	</div>
